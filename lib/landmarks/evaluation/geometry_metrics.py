...
* The primary score is :func:`score_alignment_geometry_v1`. NME / PCK
  remain available via :mod:`lib.landmarks.evaluation.profile_metrics` for
...
def _normalize_bbox(
    ...
    Thin wrapper over :func:`lib.landmarks.datasets.manifest_io.coerce_bbox` — the
    canonical xywh / ltrb coercion lives in :mod:`lib.landmarks.datasets.manifest_io`
...
def _points_outside(
    ...
    *,
    ...
    from lib.landmarks.evaluation.geometry_signals import points_outside_bbox
