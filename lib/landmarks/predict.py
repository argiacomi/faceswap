...
from lib.landmarks.fusion import plain_average, static_weighted
...
def predict_landmarks_68(
    ...
    *,
    ...
    is a robust z-score in landmark coordinate space.
    """
    if not adapters:
    ...
    if strategy == "static_weighted_outliers":
        return static_weighted(
            predictions,
            weight_matrix,
    ...
    if strategy == "static_weighted_downweight":
        return static_weighted(
            predictions,
            weight_matrix,
    ...
    raise ValueError(f"Unknown landmark ensemble strategy '{strategy}'")
