...
class ProjectSessionState:
    ...
    This state object therefore keeps the legacy GUI options as the single mutable source
    of truth.
    """
...
__all__ = get_module_objects(__name__)
    ...
    def set_project(self, project: ProjectFile) -> None:
        """Set the current project model and derived legacy options."""
        self.project = project
        self._options = project.to_legacy_options()

    def set_options(self, options: LegacyOptions | None) -> None:
        """Set raw legacy GUI options."""
        self.project = None
        self._options = options
