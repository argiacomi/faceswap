        ...
        argument_list.append(
            {
                ...
                "help": _(
                    ...
                    "in "
                    "mask settings)."
                    "\nL|segnext-fp: SegNeXt-based face parser. Drop-in alternative to bisenet-fp "
                    "that typically yields cleaner edges and a better hair/skin boundary at "
                    "higher VRAM and runtime cost."
                    "\nL|ensemble: Confidence-weighted combination of two or more semantic "
                    "maskers. Configure source models and union/intersection strategy in mask "
                    "settings."
        ...
        argument_list.append(
            {
                ...
                "help": _(
                    ...
                    "\nL|adaface: AdaFace iResNet101 model that produces 512-dim normalized "
                    "embeddings with MIT-licensed weights."
                    "\nL|insightface: InsightFace recognition with configurable antelopev2, "
                    "buffalo_l or buffalo_sc model type. Check upstream non-commercial terms."
        ...
        argument_list.append(
            {
                ...
                "help": _(
                    ...
                    "\nL|segnext-fp_face: SegNeXt face parser, face-centered. Drop-in alternative "
                    "to bisenet-fp_face with cleaner edges and a better hair/skin boundary."
                    "\nL|segnext-fp_head: SegNeXt face parser, head-centered. Drop-in alternative "
                    "to bisenet-fp_head with cleaner edges and a better hair/skin boundary."
                    "\nL|ensemble_face: Confidence-weighted ensemble mask, face-centered."
                    "\nL|ensemble_head: Confidence-weighted ensemble mask, head-centered."
