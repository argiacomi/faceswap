        ...
        argument_list.append(
            {
                ...
                "dest": "output",
                "help": _(
                    "Output file. If no output is specified then: if the output is meant to be "
        ...
        argument_list.append(
            {
                ...
                "default": ".png",
                "help": _(
                    "Image format that extracted images should be saved as. '.bmp' will offer "
        ...
        argument_list.append(
            {
                ...
                "default": "00:00:00",
                "help": _(
                    "Enter the end time to which an action is to be applied. If both an end "
        ...
        argument_list.append(
            {
                ...
                "default": False,
                "help": _(
                    "Mux the audio from the reference video into the input video. This option "
        ...
        argument_list.append(
            {
                ...
                "default": None,
                "help": _(
                    "Transpose the video. If transpose is set, then degrees will be ignored. "
        ...
        argument_list.append(
            {
                ...
                "default": False,
                "help": _(
                    "Increases output verbosity. If both quiet and verbose are set, verbose "
                    "will override quiet."
                ),
            }
        )
