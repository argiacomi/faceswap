...
class Trainer(OriginalTrainer):
    ...
    def _validate_batch_size(self, batch_size: int) -> int:
        ...
        if batch_size % self._gpu_count:
            ...
            logger.warning(
                "Batch size %s is sub-optimal for %s GPUs. You may want to adjust your "
    ...
    def _handle_torch_gpu_mismatch_warning(
        self, warn_messages: list[warnings.WarningMessage] | None
    ) -> None:
    ...
    def _set_distributed(self) -> torch.nn.DataParallel:
        ...
        logger.info(
            "Distributed training enabled. Model: '%s', devices: %s",
            name,
            wrapped.device_ids,
        )
        return wrapped
