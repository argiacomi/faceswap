...
profile_warmup_time = ConfigItem(
    ...
    group=_("profile"),
    info=_(
        "The number of seconds to warmup the model for at each batch size. Higher times will "
...
profile_test_time = ConfigItem(
    ...
    group=_("profile"),
    info=_(
        "The number of seconds to profile the pipeline for at each batch size. Higher times "
...
profile_num_faces = ConfigItem(
    ...
    group=_("profile"),
    info=_(
        "The average number of faces expected to be detected in each frame. Throughput of "
...
profile_max_vram = ConfigItem(
    ...
    group=_("profile"),
    info=_(
        "The maximum amount of total GPU VRAM to allow Cuda to reserve when searching for "
